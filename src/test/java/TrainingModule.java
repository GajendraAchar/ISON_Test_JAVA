...
public class TrainingModule {	
	...
	@Test
	public void TestOnlineTraining() throws InterruptedException
	{
		...
		try {
			...
			boolean var88=driver.findElement(By.xpath("//button[@type='submit']")).isDisplayed();
		...
		User1.selectByVisibleText("Kapil Dev (68010902724)");
		Thread.sleep(2000);
		...
		try {
			...
			driver.findElement(By.id("username")).sendKeys("68010902724");//Kapil
			Thread.sleep(6000);
			driver.findElement(By.id("password")).sendKeys(config.getSGAUserPassword());
			Thread.sleep(6000);
			...
			driver.findElement(By.id("username")).sendKeys("68010902724");
			Thread.sleep(6000);
			driver.findElement(By.id("password")).sendKeys(config.getSGAUserPassword());
			Thread.sleep(6000);
