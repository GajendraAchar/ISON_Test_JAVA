...
public class addEditDelLob {
	...
	public void testAddEditDelLob() throws Exception {
		...
		System.out.println("Lob added Successfully !!");
		...
		if (var44==true)
		{
			driver.findElement(By.tagName("input")).sendKeys("ViLOB");
			Thread.sleep(25000);
		}


		boolean var3= driver.findElement(By.xpath("//tbody/tr[1]/td[6]/a[2]")).isDisplayed();
